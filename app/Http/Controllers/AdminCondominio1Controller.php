<?php namespace App\Http\Controllers;
	...
	class AdminCondominio1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:condominio','width'=>'col-sm-10','placeholder'=>'Por favor digite um endereço de e-mail válido'];
			...
			$this->form[] = ['label'=>'UF','name'=>'uf_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'uf,nome'];
